...
palabras = [
    "igualdad", "respeto", "diversidad", "empatía", "justicia", "protección", "educación", "salud", "dignidad", "integración", "accesibilidad", "participación", "solidaridad", "tolerancia", "bienestar" 
]
tamaño = 18  # Tamaño de la cuadrícula (15x15)
